		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">属性列表</h4></li>
				</ul>
		...
		<form action="" method='post'>
			<table class='table table-striped'>
				...
				<?php if(is_array($attr)): foreach($attr as $key=>$v): ?><tr>
						...
						<td>
							<div style=" width: 20xp;height: 20xp;background: <?php echo ($v["color"]); ?>"><?php echo ($v["color"]); ?></div>

						</td>
						<td>[<a href="">修改</a>] &nbsp; [<a href="<?php echo U(GROUP_NAME . '/Attribute/deleteAttr',array('id' => $v['id']));?>">删除</a>]</td>
