...
<html>
		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">查询统计金额</h4></li>
				</ul>
	...
	<!--	<div class="am-g">-->
		...
		<form action="<?php echo U(GROUP_NAME . '/Add/add');?>" method="post">
			<table class='table'>
				<tr>
					<th colspan="2">选择日期</th>
				</tr>
				<tr>
					<td align="right">年：</td>
					<td>
						<select class="form-control" name="year">
							...
							<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><option value="<?php echo ($v["year"]); ?>"><?php echo ($v["year"]); ?></option><?php endforeach; endif; ?>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select class="form-control" name="month">
							...
							<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><option value="<?php echo ($v["month"]); ?>"><?php echo ($v["month"]); ?></option><?php endforeach; endif; ?>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<select class="form-control" name="day">
							...
							<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><option value="<?php echo ($v["day"]); ?>"><?php echo ($v["day"]); ?></option><?php endforeach; endif; ?>
						</select>
					</td>
				</tr>
