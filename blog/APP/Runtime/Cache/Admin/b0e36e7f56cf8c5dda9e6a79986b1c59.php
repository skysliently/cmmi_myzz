		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">业务列表</h4></li>
				</ul>
		...
		<form action="<?php echo U(GROUP_NAME . '/Category/sortCate');?>" method='post'>
			<table class='table table-striped'>
				...
				<?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
						...
						<td>
							<input class="form-control" type="text" name="<?php echo ($v["id"]); ?>" value="<?php echo ($v["sort"]); ?>">
						</td>
						<td>
				...
				<tr>
					<td colspan="5" align="center">
						<input class="btn btn-info" type="submit" value="排序">
					</td>
				</tr>
			</table>
		</form>
