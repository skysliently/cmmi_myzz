		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">回收站</h4></li>
				</ul>
				    ...
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    <li><a href="http://localhost/blog/index.php/Index/"><span class="am-icon-home"></span> 首页</a></li>
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav1'}"><span class="am-icon-table"></span> 博文管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav1">
						        <li><a href="<?php echo U(GROUP_NAME . '/Blog/blog');?>" class="am-cf"> 添加博文</span></a></li>
						        <li><a href="<?php echo U(GROUP_NAME . '/Blog/index');?>">博文列表</a></li>
						        <li><a href="<?php echo U(GROUP_NAME . '/Blog/trach');?>" class="am-cf">回收站</span></a></li>
						      </ul>
						    </li>
						    <li class="admin-parent">
						    ...
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav5'}"><span class="am-icon-file"></span> 分类管理
                               <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav5">
						        <li><a href="<?php echo U(GROUP_NAME . '/Category/addCate');?>" class="am-cf"> 添加分类</a></li>
		...
		<form action="<?php echo U(GROUP_NAME . '/Blog/addBlog');?>" method="post">
			<table class='table table-striped'>
				...
				<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><tr>
						...
						<td>
							[<a href="<?php echo U(GROUP_NAME . '/Blog/repealTrach', array('id' => $v['id']));?>">恢复</a>]
							[<a href="<?php echo U(GROUP_NAME . '/Blog/deleteTrach', array('id' => $v['id']));?>">彻底删除</a>]
						</td>
