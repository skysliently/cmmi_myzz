		...
		<header class="am-topbar am-topbar-fixed-top">		
			...
			<div class="contain">
				<ul class="am-nav am-navbar-nav am-navbar-left">
					...
					<li><h4 class="page-title">添加订单</h4></li>
				</ul>
	...
	<!--	<div class="am-g">-->
		...
		<form action="<?php echo U(GROUP_NAME . '/Blog/addBlog_admin');?>" method="post">
			<table class='table'>
				...
				<tr>
					<td align="right" >所属顾客：</td>
					<td>
						<select class="form-control" name="vid">
							<option value="">===选择姓名===</option>
							<?php if(is_array($visitor)): foreach($visitor as $key=>$v): ?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; ?>
						</select>
					</td>
				</tr>
				<tr>
